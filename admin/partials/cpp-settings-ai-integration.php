        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">
                        <?php echo esc_html__(__('Provides intelligent troubleshooting and code generation assistance.', 'content-protect-pro'), 'content-protect-pro'); ?>
                    </p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php else: ?>
                        <p class="description">
                            <?php echo esc_html__(__('Configure API key and enable AI Assistant to access the assistant.', 'content-protect-pro'), 'content-protect-pro'); ?>
                        </p>
                    <?php endif; ?>
                </td>
            </tr>
