...
class CPP_Public {
    ...
    public function protected_video_shortcode($atts) {
        ...
        if (empty($atts['id'])) {
            return '<p class="cpp-error">' . esc_html__('Presto Player video ID is required.', 'content-protect-pro') . '</p>';
        }
        ...
        if ($requires_code) {
            ...
            if (!$validation['valid']) {
                return '<div class="cpp-protected-content"><p>' . 
                       esc_html__('Invalid or expired gift code.', 'content-protect-pro') . 
                       '</p></div>';
            }
                ...
                <?php else: ?>
                    <div class="cpp-no-videos">
                        <div class="cpp-empty-state">
                            ...
                            <p><?php esc_html_e('There are no videos in your library yet.', 'content-protect-pro'); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
