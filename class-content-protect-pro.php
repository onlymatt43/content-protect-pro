...
class Content_Protect_Pro {
    ...
    private function load_dependencies() {
        ...
        /**
         * Enhanced Video Library System
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cpp-video-library.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/cpp-ajax-library.php';
        
        // Register enhanced shortcodes
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/cpp-shortcodes-enhanced.php';
